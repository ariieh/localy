LocalyBackbone.Views.Chatbox = LocalyBackbone.LocalyView.extend({
  init: function(options){
    ...
    this.listenTo(window.place, "change", function() { this.swapHoodButtonAttr(window.place.get("currentLocation")) });
  },
  ...
  swapHoodButtonAttr: function(attribute) {
    $(".hood-button").attr("hood", attribute);
  },
