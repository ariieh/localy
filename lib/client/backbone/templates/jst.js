...
window.JST['map/main-map'] = _.template("");

window.JST['map/popup-header'] = _.template(hereDoc(function(userID) {/*!
  <span class='popup-header <%= Localy._myName(userID) %>' id='popup-header-<%= userID %>'>
    username
  </span>
*/}));
