...
*/})),
  ...
  <div id="chatbox-button-wrapper">
    ...
    <div class="nifty-box blue chatroom-button hood-button" hood=<%= window.placename %>>
      'Hood
...
*/})),
  ...
  */})),
  ...
  'hood-button': _.template(hereDoc(function(hood) {/*!
    <div class='nifty-box chatroom-button hood-button' hood=<%= hood %>>
      <%= hood %>
      <span style='display: inline' class='notification-badge'></span>
    </div>
  */}))
