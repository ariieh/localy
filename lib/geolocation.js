window.Locator = {
    ...
    navigator.geolocation.getCurrentPosition(function(position){
			...
			map = map.setView(position, 17);
			socket.emit('load marker', position, name, socket.io.engine.id);
			
			var placeName = leafletPip.pointInLayer([that.longitude, that.latitude], geojson)[0].feature.properties.NTAName;
