...
window.Localy = {
	...
	displayMessage: function(msg, userID, type, bounds) {
		...
		var $activeChatboxUl = $chatbox.children('ul.active');
		...
		$activeChatboxUl.append(content);
		$chatbox.animate({ scrollTop: $activeChatboxUl.height() }, "fast");
	},
	...
	joinRemote: function(lat, lon) {
		...
		Localy._swapActiveUl(bounds.degree.lat + "-" + bounds.degree.lon);
	},
